    ...
    <Row>
      <Col>
        <Row className="justify-content-center">
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/Eat-Da-Burgers.png" />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/Employee-directory.png" />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/Note Taker.PNG" />
              <Card.Body>
        ...
        <Row className="justify-content-center mt-4">
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/WorkDayPlanner.PNG" />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/Weatherdashboard.PNG" />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src="/img/COVID19symptom.PNG" />
              <Card.Body>
