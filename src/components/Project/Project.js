    ...
    <Row>
      <Col>
        <Row className="justify-content-center">
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/Eat-Da-Burgers.png"} />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/Employee-directory.png"} />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/Note Taker.PNG"} />
              <Card.Body>
        ...
        <Row className="justify-content-center mt-4">
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/WorkDayPlanner.PNG"} />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/Weatherdashboard.PNG"} />
              <Card.Body>
          ...
          <Col md>
            <Card>
              <Card.Img variant="top" src={proces.env.PUBLIC_URL+"/img/COVID19symptom.PNG"}/>
              <Card.Body>
